...
- Loops are **time-of-day aware**: each has a window (morning from 5am, afternoon from noon, evening from 5pm, or anytime) that gates when "due now" starts — Evening Shutdown won't nag at breakfast; it shows softly under “Later today” until 5pm. Windows never expire within the day (running late is always allowed), and completed runs schedule their next due time at **local midnight** boundaries rather than a drifting 24-hours-later. Monthly cadence approximates to 30 days.
